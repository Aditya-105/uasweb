...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('/image/logo-retina.png')); ?>">
...
<section id="about" class="flex flex-col items-center justify-center bg-light">
    ...
    <div class="mt-1 md:mt-4 m-4 flex self-center flex-col">
        <div class="img-size "><img src="<?php echo e('image/logo-retina.png'); ?>" alt=""></div>
        <h1 class="font-extrabold text-4xl mt-1 mb-2 mm:my-4 border-b-4 border-indigo-600 self-start leading-tight"><?php echo e($profil->judul); ?></h1>
        <p class="text-lg"><?php echo e($profil->keterangan); ?></p>
        <div class="flex">
...
<section id="paket" style="padding-top:70px; padding-bottom:70px; background-color:white;" id="whyus" class="flex flex-col sm:flex-row flex-wrap justify-between">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="flex flex-col items-center w-full sm:w-1/2 bg-white p-4">
            <img width=250 src="<?php echo e(asset('image/'.$item->foto)); ?>" alt="">
            <h3 class="text-4xl font-bold text-indigo-600"><?php echo e($item->nama_paket); ?></h3>
            <p class="text-center mb-4"><?php echo e($item->keterangan); ?></p>
        </div >
...
<section id="showcase" class="h-screen bg-white p-4 px-8 flex flex-col justify-center items-center">
    ...
    <div class="owl-carousel owl-theme">
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="<?php echo e(asset('image/portfolio1.jpg')); ?>" src="<?php echo e(asset('image/portfolio1.jpg')); ?>" class="owl-lazy w-full shadow-lg"></div>
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="<?php echo e(asset('image/portfolio2.jpg')); ?>" src="<?php echo e(asset('image/portfolio2.jpg')); ?>" class="owl-lazy w-full shadow-lg"></div>
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="<?php echo e(asset('image/portfolio3.jpg')); ?>" src="<?php echo e(asset('image/portfolio3.jpg')); ?>" class="owl-lazy w-full shadow-lg"></div>
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="<?php echo e(asset('image/portfolio4.jpg')); ?>" src="<?php echo e(asset('image/portfolio4.jpg')); ?>" class="owl-lazy w-full shadow-lg"></div>
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="<?php echo e(asset('image/portfolio5.jpg')); ?>" src="<?php echo e(asset('image/portfolio5.jpg')); ?>" class="owl-lazy w-full shadow-lg"></div>
    </div>
</section>
...
</html><?php /**PATH D:\BELAJAR WEB\LARAVEL NEW\laravel-crud\resources\views/index.blade.php ENDPATH**/ ?>