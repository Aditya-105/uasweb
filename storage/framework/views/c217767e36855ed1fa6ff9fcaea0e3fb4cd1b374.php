      ...
      <aside class="sidebar">
        <menu>
          <ul class="menu-content">
            ...
            <li>
              <a href="<?php echo e(route('paket.create')); ?>"><i class="fa fa-cube"></i> <span>PROFIL</span> <i class="fa fa-angle-down pull-right"></i></a>
              <ul>
                <li><a href="">Merk</a></li>
...
</html><?php /**PATH D:\BELAJAR WEB\LARAVEL NEW\laravel-crud\resources\views/layouts/template.blade.php ENDPATH**/ ?>