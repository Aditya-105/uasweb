                ...
                <div class="page-body">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form role="form" method="post" action="<?php echo e(url('profil/edit/'.$datas->id)); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="judul" placeholder="Masukkan Judul" value="<?php echo e($datas->judul); ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label"><i class="fa fa-info-circle mr-1"></i> Keterangan</label>
                                    <div class="col-sm-10">
                                        <textarea rows="5" cols="5" class="form-control" name="keterangan" placeholder="Masukkan Keterangan"><?php echo e($datas->keterangan); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="mb-3">
                                            ...
                                            <img src="<?php echo e(asset('image/'.$datas->logo)); ?>" style="width:20%" alt="">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="mb-3">
                                            ...
                                            <img src="<?php echo e(asset('image/'.$datas->foto)); ?>" style="width:20%" alt="">
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BELAJAR WEB\LARAVEL NEW\laravel-crud\resources\views/profil/index.blade.php ENDPATH**/ ?>