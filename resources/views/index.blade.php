...
<section id="showcase" class="h-screen bg-white p-4 px-8 flex flex-col justify-center items-center">
    ...
    <div class="owl-carousel owl-theme">
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="{{ asset('image/portfolio1.jpg') }}" src="{{ asset('image/portfolio1.jpg') }}" class="owl-lazy w-full shadow-lg"></div>
        <div class="m-8 shadow-md rounded overflow-hidden"><img data-src="{{ asset('image/portfolio2.jpg') }}" src="{{ asset('image/portfolio2.jpg') }}" class="owl-lazy w-full shadow-lg"></div>
